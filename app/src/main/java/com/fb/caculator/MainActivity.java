...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Button btn_0,btn_1,btn_2,btn_3,btn_4,btn_5,btn_6,
            ...
            btn_sub,btn_add,btn_equ,btn_p,btn_fac;
    EditText text;
    int leftBraNum = 0;
    int rightBraNum = 0;
    @Override
    ...
    public void onClick(View v) {
        ...
        char c2 = str.length()>1? str.charAt(str.length() - 2) :'0';
        ...
        switch(v.getId()){
            ...
            case R.id.btn_0:
                if (str.equals("0")){
                    str="0";
                }else if(operatorIssLegal(c2)&&c=='0'){
            ...
            case R.id.btn_leftbra:
                ...
                else if (operatorIssLegal(c)){
                    str += "(";
                }else{
                    Toast.makeText(MainActivity.this,"illegal symbol (",Toast.LENGTH_SHORT).show();
                    leftBraNum--;
                }
                leftBraNum++;
                text.setText(str);
            ...
            case R.id.btn_rightbra:
                if (str.length()==1 || leftBraNum<=rightBraNum || !numberIsLegal(c)){
                    Toast.makeText(MainActivity.this,"illegal symbol )_1",Toast.LENGTH_SHORT).show();
                } else{
                    if(str.charAt(str.length() - 2) =='('){
                        Toast.makeText(MainActivity.this,"illegal symbol )_2",Toast.LENGTH_SHORT).show();
                    }else{
                        str += ")";
                        rightBraNum++;
                    }
                ...
                text.setText(str);
                Log.i("btn_rightbra",str);
                break;
            case R.id.btn_equ:
                Log.i("equal",str);
                if(operatorIssLegal(c)){
            ...
            case R.id.btn_sin:
                if(csIsLegal(str)){
                    ...
                    Toast.makeText(MainActivity.this,"illegal sin(x)",Toast.LENGTH_SHORT).show();
                }
                break;
            case R.id.btn_cos:
                if(csIsLegal(str)){
                    ...
                    Toast.makeText(MainActivity.this,"illegal cos(x)",Toast.LENGTH_SHORT).show();
                }
                break;
            case R.id.btn_fac:
                if(csIsLegal(str)){
                    if(str.contains(".")){
                        Toast.makeText(MainActivity.this,"error contain decimal",Toast.LENGTH_SHORT).show();
                    }else{
                    ...
                    Toast.makeText(MainActivity.this,"illegal n!",Toast.LENGTH_SHORT).show();
                }
                break;
            case R.id.btn_PandM:
    ...
    private boolean operatorIssLegal(char c){
        if(c=='+'||c=='-'||c=='×'||c=='÷'){
            return true;
        }
        return false;
    ...
    private boolean dotIsLegal(char c){
        if(c=='+'||c=='-'||c=='×'||c=='÷'||c=='('||c==')'){
            return false;
        }
        return true;
    ...
    private boolean numberIsLegal(char c){
        if(c==')' || (c>='0' && c<='9')){
            return true;
        }
        return  false;
    ...
    private boolean csIsLegal(String s){
        Log.i("csIsLegal",s);
